function [impact, gam] = identification_GPFA_2delta(A,B,SRhorizon,SRhorizonIV,EBPposition,...
      Uposition,IVposition,delta1,delta2)
...
% delta1 is penalty function parameter for the first shock
% delta2 is penalty function parameter for the second shock
...
objU = @(gamU) objective_PFA(Uposition,IVposition,SRhorizon,...
      SRhorizonIV,B,A,gamU,delta2);
